            ...
            <div class="invoice-container">
                <div class="invoice-header my-3">
                    <div class="col-12">
                        ...
                        <h1 class="text-center lead fs-2 fw-bold">Boleta Electronica</h1>
        ...
        document.getElementById('invoice-form').addEventListener('submit', async (e) => {
            ...
            if (!fecha || !dni || !nombre) {
                mostrarMensajeAlerta(400,
                    'Por favor, complete los campos de fecha, DNI y Nombre del Cliente antes de generar la boleta.'
                    );
            } else if (table.rows().count() === 0) {
                mostrarMensajeAlerta(400,
                'Agregue al menos un registro a la tabla antes de generar la boleta.');
            } else {
                ...
                try {
                    const response = await CRUD.sendDataNoJson('generate-boleta', formData);
                    ...
                    mostrarMensajeAlerta(500, 'Error interno al generar la boleta.');
                }
            }
        });
    </script>
