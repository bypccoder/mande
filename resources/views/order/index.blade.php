...
@section('scripts')
    ...
    <script>
        ...
        function submitNotaCredito(e) {
            ...
            CRUD.sendDataNoJson('sunat/nota-credito', formData).then(response => {
                // let modalNotaCredito2 = document.querySelector('#modal-nota-credito');
                // modalNotaCredito2.style.display = 'none';
